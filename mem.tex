...
In order to optimize the MEM code, we have used the~\texttt{igprof}~sampling profiler~\cite{Tuura:2008zza} to analyze the computational budget spent in various subroutines of the code. In general, we find    
