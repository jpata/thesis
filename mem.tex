...
\end{itemize}
The jets are assumed to be b~tagged or untagged by choosing the set of jets that is most compatible with arising from a 4 b~quark hypothesis using a likelihood ratio based on jet b~discriminators, as will be explained further in~\cref{sec:object_id_btag}. Overall, the number of MEM combinations that are required for each hypothesis in the categories we use is show in~\cref{tab:category_combinations}. These assumptions are found not to reduce the performance of the MEM significantly, but they decrease the number of permutations (and thus computational burden) by an order of magnitude, as seen on figure~\cref{fig:mem_assumptions}.

\begin{table}[h!]
\begin{center}
\begin{tabular}{c|cccc}
\hline
interpretation & 7 jets & 6 jets & 5 jets & 4 jets \\
\hline
SL~$2_{\mathrm{W}} 2_{\mathrm{h}} 2_{\mathrm{t}}$ & 36 & 12 & - & - \\
SL~$1_{\mathrm{W}} 2_{\mathrm{h}} 2_{\mathrm{t}}$ & - & - & 12 & -\\
SL~$0_{\mathrm{W}} 2_{\mathrm{h}} 2_{\mathrm{t}}$ & - & - & - & 12 \\
SL~$2_{\mathrm{W}} 2_{\mathrm{h}} 2_{\mathrm{t}}+1\mathrm{g}$ & 32 & - & - & - \\
\hline
DL~$2_{\mathrm{h}} 2_{\mathrm{t}}$ & - & - & - & 12 \\
\hline
\hline
\end{tabular}
\caption[The number of MEM combinations in different categories]{The number of MEM combinations in associating quarks to jet for various MEM categories. In events with 7 or more jets, we choose up to 3 candidates based on invariant mass among the light jets for the W-boson reconstruction, in order to bound the number of permutations.}
...
\begin{figure}
\begin{centering}
\subfloat[fig 1]{\includegraphics[width=0.5\textwidth]{figures/jetsByPt_0_pt.pdf}} 
\subfloat[fig 2]{\includegraphics[width=0.5\textwidth]{figures/jetsByPt_0_pt.pdf}}\\
...
\hline
SL 6j4t & SL $2_{\mathrm{W}} 2_{\mathrm{h}} 2_{\mathrm{t}}$ & 0.20 & 0.51 & 0.69 \\
SL 6j3t & SL $2_{\mathrm{W}} 2_{\mathrm{h}} 2_{\mathrm{t}}$ & 0.09 & 0.24 & 0.52 \\
SL 5j4t & SL $1_{\mathrm{W}} 2_{\mathrm{h}} 2_{\mathrm{t}}$ & 0.36 & 0.59 & 0.74 \\
...
\hline
DL 4j4t & DL $2_{\mathrm{h}} 2_{\mathrm{t}}$ & 0.59 & 0.59 & 0.74 \\
DL 4j3t & DL $2_{\mathrm{h}} 2_{\mathrm{t}}$ & 0.30 & 0.30 & 0.55 \\
\hline
\hline
\end{tabular}
...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width = 1.0\textwidth]{figures/mem/mem_sl_j4_t4.pdf}
...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width = 1.0\textwidth]{figures/mem/mem_sl_j4_t3_blrH.pdf}
...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width = 1.0\textwidth]{figures/mem/mem_sl_j5_tge4.pdf}
...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width = 1.0\textwidth]{figures/mem/mem_sl_jge6_tge4.pdf}
...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width = 1.0\textwidth]{figures/mem/mem_sl_jge6_tge4_1w2h2t.pdf}
...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width = 1.0\textwidth]{figures/mem/mem_sl_jge7_tge4.pdf}
...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width = 1.0\textwidth]{figures/mem/mem_sl_jge7_tge4_1g.pdf}
