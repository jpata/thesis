...
\begin{figure}
\begin{centering}
\subfloat[Integration time of the MEM.]{\includegraphics[width = 0.5\linewidth]{figures/mem_time.pdf}} 
\subfloat[Numerical uncertainty of the MEM]{\includegraphics[width = 0.5\linewidth]{figures/mem_error.pdf}}\\
...
In order to optimize the MEM code, we have used the~\texttt{igprof}~sampling profiler~\cite{Eulisse:2005zz,Tuura:2008zza} to analyse the computational budget spent in various subroutines of the code. In general, we find    
