...
\fixme{check top decay amplitude dimension}
...
We use a number of strategies to restrict the number of combinations that need to be considered in the transfer functions of~\cref{eq:tf_combination_sum}. 
...
\begin{figure}[ht]
\begin{centering}
\subfloat[Semileptonic category]{\includegraphics[width = 0.5\textwidth]{figures/mem/kappa_opt_sl_jge6_tge4.pdf}}
\subfloat[Dileptonic category]{\includegraphics[width = 0.5\textwidth]{figures/mem/kappa_opt_dl_jge4_tge4.pdf}}\\
