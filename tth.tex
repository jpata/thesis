...
We use this likelihood as a classifier between the various~\ttbar+jets sub-processes, as well as to select the bottom quark candidates in the application of the MEM, as described in~\cref{sec:mem_application}. 
...
\begin{figure}
\begin{centering}
\subfloat[JES uncertainty]{\includegraphics[width = 0.4\textwidth]{figures/tth/ttH_hbb__sl_jge6_tge4__mem_SL_2w2h2t__CMS_scaleFlavorQCD_j.pdf}}
\subfloat[B~tagging uncertainty]{\includegraphics[width = 0.4\textwidth]{figures/tth/ttH_hbb__sl_jge6_t3__btag_LR_4b_2b_btagCSV_logit__CMS_ttH_CSVlf.pdf}} \\
